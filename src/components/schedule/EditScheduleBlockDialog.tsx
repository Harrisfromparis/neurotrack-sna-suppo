...
import { Student, ScheduleBlock } from '@/lib/types'
...
interface EditScheduleBlockDialogProps {
  open: boolean
...
export function EditScheduleBlockDialog({ open, onOpenChange, block, studentId, students }: EditScheduleBlockDialogProps) {
  ...
  useEffect(() => {
    if (block) {
      setFormData({
        ...
        accommodations: block.accommodations || [],
        requiredSupport: block.requiredSupport,
        isRecurring: block.isRecurring,
        recurringDays: block.recurringDays || [],
        materials: block.materials || [],
        preparationNotes: block.preparationNotes || '',
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault()
    if (!selectedStudent || !selectedStudent.schedule) return
    ...
    try {
      ...
      const updatedBlocks = selectedStudent.schedule.blocks.map(b => 
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Update the schedule block for {selectedStudent?.name}
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <DialogFooter>
            ...
            <Button type="submit" disabled={isLoading}>
              {isLoading ? 'Updating...' : 'Update Schedule Block'}
            </Button>
          </DialogFooter>
        </form>
      </DialogContent>
